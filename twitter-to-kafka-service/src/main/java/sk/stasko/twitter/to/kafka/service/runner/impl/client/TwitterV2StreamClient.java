package sk.stasko.twitter.to.kafka.service.runner.impl.client;
...
public class TwitterV2StreamClient {

    private static final Logger LOG = LoggerFactory.getLogger(TwitterV2StreamClient.class);
    ...
    private static final String tweetAsRawJson = "{" +
            ...
            "\"user\":{\"id\":\"{3}\"}" +
            "}";
    private static final String TWITTER_STATUS_INPUT = "yyyy-MM-dd'T'HH:mm:ss.SSS'Z'";
    private static final String TWITTER_STATUS_DATE_FORMAT = "EEE MMM dd HH:mm:ss ZZZZZ yyyy";

    @Autowired
    public TwitterV2StreamClient(TwitterToKafkaConfigData twitterToKafkaConfigData,
    ...
    public void connectStream(String bearerToken) throws IOException, URISyntaxException {
        ...
        URIBuilder uriBuilder = new URIBuilder(this.twitterToKafkaConfigData.getTwitterV2BaseUrl());
            ...
            while (line != null) {
                ...
                if (line != null && !line.isEmpty()) {
                    ...
                    try {
                        ...
                        LOG.error("Could not create status for text: {}", tweet, twitterException);
                    }
                    if (status != null) {
    ...
    private void createRules(String bearerToken, Map<String, String> rules) throws URISyntaxException, IOException {
        ...
        URIBuilder uriBuilder = new URIBuilder(this.twitterToKafkaConfigData.getTwitterV2RulesBaseUrl());
    ...
    private String getFormattedTweet(String data) {
        ...
        String[] params = new String[] {
                this.parseTwitterDate(jsonObject.get("created_at").toString()),
    ...
    private String parseTwitterDate(String date) {
        SimpleDateFormat input = new SimpleDateFormat(TWITTER_STATUS_INPUT);
        SimpleDateFormat output = new SimpleDateFormat(TWITTER_STATUS_DATE_FORMAT);
        ...
        {
            LOG.error("Could not parse Simple Date Format for date: {}", date, e);
        }
