...
public class TwitterKafkaConsumer implements KafkaConsumer<Long, TwitterAvroModel> {
    ...
    private static final String KAFKA_LISTENER_ID = "twitterTopicListener";
    ...
    public void onAppStarted(ApplicationStartedEvent event) {
        ...
        kafkaListenerEndpointRegistry.getListenerContainer(KAFKA_LISTENER_ID).start();
    }

    @Override
    @KafkaListener(id=KAFKA_LISTENER_ID, topics = "${kafka-config.topic-name}")
